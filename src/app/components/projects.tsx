            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
              <div className="flex relative">
                <Image
                  ...
                  src={require("../../../public/image/pic3.png")}
                  alt="image"
                />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed line-clamp-2">
                   One resource mentions front-end developer resume examples that highlight skills like progressive web app development and responsive design. Another resource suggests that front-end developers should highlight their experience with responsive design, modern frameworks, and collaboration with UX/UI designers on their resumes.                  </p> 
                  <Link
                    target="_blank"
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
              <div className="flex relative">
                 <Image
                  alt="image"
                  className="absolute inset-0 w-full h-full object-cover object-center"
                  src={require("../../../public/image/pic1.png")}
                />
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100"> */
                  <h2 className="tracking-widest text-sm title-font font-medium text-blue-500 mb-1">
                    Sms Project
